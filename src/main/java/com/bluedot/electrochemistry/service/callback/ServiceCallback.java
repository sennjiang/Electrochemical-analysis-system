...
public interface ServiceCallback<T> extends Callback {
     ...
     * @return 数据条数
     */
    default Long doCountExecutorByDropdown(BaseMapper baseMapper, String[] dropdownType, int[] dropdownValue) {
        return null;
    }
     ...
     * @return 数据条数
     */
    default Long doCountExecutorByQueryConditionAndDropdown(BaseMapper baseMapper, String queryCondition, String[] dropdownType, int[] dropdownValue) {
        return null;
    }
