...
public class User {
	 ...
	 * @Date 2021/9/4 14:50
	 **/
	public User(Integer username, String password, String nickname, Integer gender, Integer age, String email, Timestamp birth, Integer status, String portrait, Timestamp gmtCreated) {
